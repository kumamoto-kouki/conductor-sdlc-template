...
![あなたの会社の仕事に合わせたソフトを AI に作らせる話。作りたいことを言葉で伝えると AI がプログラムを書き、このテンプレートが本当にできているかを確かめる。あなたがやるのは、何を作るかを決めることと、自分の書類を1枚、最初から最後まで作らせて確かめてから承認すること。先に不利なこととして、導入に Mac なら30分〜1時間・Windows なら1時間半〜2時間かかること、月ぎめの契約が要り無料では使えないこと（2026年8月時点で月20ドルほどから）、AI だけでは終わらない場面が2つ（画面の見た目の判断と、本当に動くかの最終確認）あること。作れるものの例は、見積書の作成・在庫の記録・作業日報の集計・社内の申請フォーム](docs/images/what-it-is.svg)
