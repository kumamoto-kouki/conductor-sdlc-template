...
![作りたいことを言葉で伝えると AI がプログラムを書き、本当にできているかを確かめる、という3段の流れ。①あなたが言葉で伝える（専門用語は要りません）②AI がプログラムを書く（読めなくても、③で確かめられます）③本当にできているか確かめる（決めたとおりに作られたか／作った AI に合格を出させない／最後に、あなたが動かして見る。ひとつでも欠けたら、完成にしません）。AI に任せるだけでは③が抜ける。この流れの中であなたがやることは、①の「何を作るかを決める」と、③の「動かして確かめてから承認する（自分の書類を1枚、最初から最後まで作らせて確かめます）」の2つ](docs/images/what-it-is.svg)
...
![あなた（プロダクトオーナー）がやることと、AI がやることの分担図。あなたは、何を作るかを決める／AI が書いた仕様を読んで承認する／画面の見た目が良いかを判断する／本当に動くかを最終確認する。後の2つは人の目が要ります。AI 側は役ごとに分かれており、調べ役が調べて案を出す、まとめ役が要件・設計・作業リストを書く、作る役がプログラムを書く、チェック役ができたものを検査する。作る役とチェック役は必ず別の AI にし、自分の作ったものを自分で合格にさせない](docs/images/roles.svg)

## 始める前に

手順に入る前に、先に不利なことも含めて5点お伝えします。読んでから、やるかどうかを決めてください。

![先に、不利なことも。時間: Mac は30分〜1時間、Windows は1時間半〜2時間（WSL を先に入れる必要があります）。お金: 月ぎめの契約が要ります。無料では使えません。2026年8月時点で月20ドルほどから。限界: AI だけでは終わらない場面が2つ（画面の見た目の判断／本当に動くかの最終確認）](docs/images/tradeoffs.svg)
