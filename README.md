...
取引先に説明する必要がある情報を扱うなら、[Anthropic のプライバシーポリシー](https://www.anthropic.com/legal/privacy)と[プライバシーセンター](https://privacy.claude.com/)を読んでから決めてください。
...
手順はマイクロソフトの[公式ガイド](https://learn.microsoft.com/ja-jp/windows/wsl/install)にあります。基本の流れは次のとおりです。
